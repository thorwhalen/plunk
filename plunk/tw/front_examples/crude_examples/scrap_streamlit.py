...
def explore_mall(
    key: KT, action: str, store_name: StoreName,
):
...
dispatchable_apply_model = inject_enum_annotations(
    dispatchable_apply_model_1, fvs=mall['fvs'], fitted_model=mall['fitted_model'],
)
...
mk_dispatchable = Pipe(
    ...
    inject_enum_annotations(learner=mall['learner_store'], fvs=mall['fvs'],),
)
