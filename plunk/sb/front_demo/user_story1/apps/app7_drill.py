...
def mk_pipeline_maker_app_with_mall(
    ...
    *,
    ...
    def map_annotations_to_classes(n_classes, session_df, d):
        st.write(f'n_classes: {b.n_classes()}')
        return d
            ...
            'map_annotations_to_classes': {
                ...
                'execution': {
                    'inputs': {
                        'n_classes': {
                            'value': b.n_classes,
                            # "on_value_change": lambda: print(f"n changed"),
                        },
                        'session_df': {'value': b.session_df,},
                        'd': {
                            ELEMENT_KEY: MultiInput,
                            'n_classes': b.n_classes(),
                            'session_df': mall['sessions_store'].get(
                                b.session_df(), None
                            ),
                        },
                    },
