...
class EditableGrid(InputBase):
    ...
    def render(self):
        ...
        gb.configure_default_column(max_column_height=3)
        ...
        gb.configure_column('Outputs', editable=True)
        gb.configure_column('Inputs', editable=True)
        ...
        return list(data['data'].itertuples())
                ...
                'execution': {
                    'inputs': {
                        'edge_table': {
                            ...
                            'editable_column': 'Function',
                            'choices': list(DFLT_FUNCS_DICT.keys()),
                        },
                    },
                    # 'output': {
